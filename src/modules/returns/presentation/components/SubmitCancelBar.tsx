/**
 * Draft → Submit and Submitted → Cancel-with-reason controls. The lifecycle
 * calls themselves go through the shared document repo (Functions); this only
 * collects intent. Mirrors `src/modules/inventory/presentation/components/SubmitCancelBar.tsx`.
 */
