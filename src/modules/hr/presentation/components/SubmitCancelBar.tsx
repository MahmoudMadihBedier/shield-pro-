...
/**
 * Lifecycle action bar for `payroll_runs`: **Submit** while Draft, **Cancel
 * (with reason)** once Submitted. Every control is hidden unless `canAct` — a
 * UX affordance only; the real gate is server-side (`SUBMIT_ROLE_BY_TABLE`).
 */
