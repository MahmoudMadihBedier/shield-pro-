/**
 * Route manifest for the `reports` module — a relative child route object
 * meant to be spread into the app router's authenticated layout route. The
 * page is `React.lazy` so it is its own chunk (`claude.md` B.7).
 *
