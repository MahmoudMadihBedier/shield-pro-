    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="mb-4 text-sm text-zinc-500">
          The app pings Supabase once at startup (see the browser console) and on the interval
      ...
      <section className="rounded-xl border border-black/10 bg-white p-5 text-sm shadow-sm dark:border-white/10 dark:bg-zinc-900">
        <h2 className="mb-3 text-base font-semibold">Supabase project</h2>
      ...
      <section className="text-sm text-zinc-500">
        ...
        build and <code className="font-mono">docs/SUPABASE_SETUP.md</code> for backend
        provisioning.
      </section>
    </div>
  )
